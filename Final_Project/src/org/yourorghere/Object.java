...
public class Object implements GLEventListener, MouseListener, MouseMotionListener {
  ...
  private int gear1, gear2, gear3, tabung1, tabung2, kerucut, baling, tabung_luar, bola;
  ...
  public void init(GLAutoDrawable drawable) {
    ...
    gl.glEndList();
     ...
     bola = gl.glGenLists(1);
    gl.glNewList(bola, GL.GL_COMPILE);
  ...
  public void display(GLAutoDrawable drawable) {
    ...
    gl.glPopMatrix();
     ...
     // Place the first gear and call its display list
    gl.glPushMatrix();
    gl.glTranslatef(3.0f, -2.0f, 4.5f);
    gl.glRotatef(angle, 0.0f, 0.0f, 1.0f);
    gl.glCallList(gear1);
    gl.glPopMatrix();
    ...
    gl.glRotatef(-3.0f * angle - 9.0f, 0.0f, 0.0f, 1.0f);
    gl.glCallList(gear2);
    gl.glPopMatrix();
  ...
  public static void Bola(GL gl) {
   ...
   public static void set_tabung (GL gl) {
//        gl.glBegin(GL.GL_QUADS);
//        
//        for (int sud = 180; sud <= 360; sud += 5) {
...
//        gl.glEnd();
                          ...
                          float tooth_depth)
  {
    ...
    r0 = inner_radius;
    r1 = outer_radius - tooth_depth / 2.5f;
