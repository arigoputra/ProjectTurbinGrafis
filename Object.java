...
//Back_Horn
    ...
    public void reshape(GLAutoDrawable drawable, int x, int y, int width, int height) {
        ...
        gl.glLoadIdentity();
        gl.glFrustum(-1.0f, 1.0f, -h, h, 5.0f, 500.0f);
        gl.glMatrixMode(GL.GL_MODELVIEW);
        gl.glLoadIdentity();
        gl.glTranslatef(-3.0f, 0.0f, -400.0f);
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        angle += 5.0f; // Rotasi melingkar berdasarkan arah jarum jam
        view_roty +=1.0f; //Rotasi berdasarkan sumbu Y
...
//Crack's 
        gl.glPushMatrix();
        gl.glTranslatef(3.0f, -2.0f, 7.0f);
        gl.glRotatef(5.0f * angle - 9.0f, 0.0f, 0.0f, 1.0f);
...
//AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
    ...
    static void Crack4(GL gl) {
        ...
        GLU glu = new GLU();
        GLUquadric q = glu.gluNewQuadric();
        glu.gluCylinder(q, 8.0, 8.2, 15.0, SLICES, STACKS);
        gl.glTranslatef(0.0f, 0.0f, BODY_LENGTH);
    }
